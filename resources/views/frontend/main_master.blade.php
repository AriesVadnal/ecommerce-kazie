       ...
       <div class="row">
        <div class="col-md-4">
            <div class="card" style="width: 18rem;">
               <img src=" " class="card-img-top" alt="..." style="height: 200px;" id="pimage">
            </div>
        </div><!-- // end col md -->
        ...
        <div class="col-md-4">
         <ul class="list-group">
            ...
            <span class="badge badge-pill badge-success" id="stockout" style="background: red; color: white;"></span></li>
         </ul>
        </div><!-- // end col md -->
...
$.ajax({
   ...
   success:function(response){
      ...
      $.each(response.carts, function(key, value){
         miniCart += `
         <div class="cart-item product-summary" style="margin-bottom: 10px;">
                  <div class="row">
                    <div class="col-xs-4">
                    ...
                    <div class="col-xs-7">
                      ...
                      <div class="price">$${value.price * value.qty} * ${value.qty}</div>
                    </div>
...
<script>
   function addToWishlish(product_id)
   {
      $.ajax({
         type:"POST",
         dataType: "json",
         ...
         success:function(response)
         {
            ...
            $.each(response, function(key, value){
               ...
               <div class="product-name"><a href="#">${value.product.product_name_en}</a></div>
					...
					<td class="col-md-2">
                  <button class="btn btn-primary icon" type="button" title="Wishlist" data-target="#exampleModal" data-toggle="modal" id="${value.product_id}" onclick="productView(this.id)"> Add To Cart</button>
					</td>
