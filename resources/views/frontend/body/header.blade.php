        ...
        <div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row"> 
          ...
          <div class="dropdown dropdown-cart"> <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
            <div class="items-cart-inner">
              ...
              <div class="total-price-basket"> <span class="lbl">cart -</span> <span class="total-price"> <span class="sign">$</span><span class="value" id="cartSubTotal">600.00</span> </span> </div>
            </div>
            </a>
            <ul class="dropdown-menu">
              <li>
                      ...
                      <div class="yamm-content ">
                        ...
                        @foreach ( $subcategories as $subcat)
                          <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                            ...
                            <h2 class="title">@if(session()->get('language') == 'hindi') {{ $subcat->subcategory_name_hin}} @else {{ $subcat->subcategory_name_en}} @endif</h2>
                            @php 
