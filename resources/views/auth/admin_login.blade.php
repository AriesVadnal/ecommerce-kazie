            ...
            @csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" :value="old('email')" name="email" id="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
							...
							<div class="text-center">
								<p class="mt-15 mb-0 text-white">Don't have an account? <a href="{{ url('/register')}}" class="text-info ml-5">Sign Up</a></p>
							</div>
						</div>
					</div>
				</div>
