...
<div class="row"> <!-- start 2nd row  -->
 ...
 <option value="{{ $subsubcat->id }}" {{ $subsubcat->id == $products->subsubcategory_id ? 'selected' : ''}}>{{ $subsubcat->subcategory_name_en }}</option>	
			@endforeach
		</select>
...
<div class="row"> <!-- start 8th row  -->
  ...
  {{ $products->long_descp_en}}
	     ...
	     <div class="form-group">
			...
			<div class="controls">
	<textarea id="editor2" name="long_descp_hin" rows="10" cols="80">{{ $products->long_descp_hin}}
						</textarea>       
	 		 </div>
		</div>
...
<div class="col-md-6">
		...
		<div class="controls">
			...
			<fieldset>
				<input type="checkbox" id="checkbox_3" name="featured" value="1" {{ $products->eatured ? 'checked' : ''}}>
...
<div class="col-md-12">
        ...
        @csrf
          ...
          <div class="card">
            <img src="{{ asset($img->photo_name) }}" class="card-img-top" style="height:280px;">
            <div class="card-body">
              <h5 class="card-title">
...
<div class="col-md-12">
    ...
    <input type="hidden" name="old_img" value="{{ $products->product_thambnail }}">
			<div class="row row-sm">
				<div class="col-md-3">
            <div class="card">
              <img src="{{ asset($products->product_thambnail) }}" class="card-img-top" style="width: 280px;">
              <div class="card-body">
