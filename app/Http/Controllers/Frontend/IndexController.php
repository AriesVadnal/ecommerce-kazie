...
class IndexController extends Controller
{
    public function index()
    {
        ...
        $special_deails = Product::where('special_deals', 1)->orderBy('id', 'DESC')->limit(6)->get();
        ...
        'hot_deals','special_offer','special_deails','skip_category_0','skip_product_0',
    ...
    public function UserPasswordUpdate(Request $request)
    {
        ...
        $hashedPassoword = Auth::user()->password;
        if (Hash::check($request->oldpassword, $hashedPassoword))
        {
