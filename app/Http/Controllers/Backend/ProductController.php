...
class ProductController extends Controller
{
    ...
    public function ProductStore(Request $request)
    {
        ...
        foreach ($images as $img)
        {
            ...
            $save_image = 'upload/products/multi-image/'.$make_name;

            MultiImg::insert([
                'product_id' => $product_id,
                'photo_name' => $save_image,
                'created_at' => Carbon::now()
            ]);
        }
    ...
    public function EditProduct($id)
    {
        ...
        return view('backend.product.product_edit', compact('products','brands','categories','subsubcategory','subcategory','multiImgs'));
    }
    ...
    public function MultiImageUpdate(Request $request)
    {
        ...
        foreach ( $imgs as $id => $img )
        {
            ...
            $make_name = hexdec(uniqid()).'.'.$img->getClientOriginalExtension();
            Image::make($img)->resize(917,1000)->save('upload/products/multi-image/'.$make_name);
            $multiName = 'upload/products/multi-image/'.$make_name;

            MultiImg::where('id', $id)->update([
                'photo_name' => $multiName,
    ...
    public function MultiImageDelete($id)
    {
        ...
        $notification = array(
            'message' => 'MultiImage Deleted Successfull',
            'alert-type' => 'success'
        );
